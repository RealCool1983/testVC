...
Program: QMSL
   ...
   $Id: //depot/HTE/QDART/QMSL6/inc/QMSL_SWDownload/QMSL_QPHONEMS_SWDL.h#31 $
  ...
  *******************************************************************************/
  ...
  QLIB_API void QLIB_QPHONEMS_SaharaConfigureCallback(HANDLE hResourceContext, swdlQPHONEMSCB pSWDL_QPHONEMS_CB);
	...
	*******************************************************************************/
	...
	QLIB_API unsigned char QLIB_QPHONEMS_FireHoseSetDigest(HANDLE hResourceContext, void *pDigestList);
